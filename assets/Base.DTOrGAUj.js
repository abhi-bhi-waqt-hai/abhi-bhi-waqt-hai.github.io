...
const en = {
  ...
  credits: {
    ...
    lede: "This is a school project, and the only page here that is about us instead of about you. That is why it is last — there is nothing on it you need.",
    /* ── 1. THE GAME, FIRST ───────────────────────────────────────────────
       Round 37, at the owner's direction: "Mention the Pulse Game first, then
       mention our roles." It was third. It is also the section that explains
       why this entry looks like a website instead of a poster, so leading with
       it is right on the merits as well as on the instruction. */
    ...
    gameBody: [
      ...
      "The thing you fight is called the Hush, and it never raises its voice once. It offers to make everything quiet — that is the whole horror of it, and it is why the game has a website: the argument PULSE makes in three hours is the argument this site makes in nine pages. It never names a substance either, not once in about two thousand four hundred words of dialogue."
    ],
    /* The who field was removed in Round 37. It said "Built by Ravi Kishor"
       and "Built by Badriprasath", which the credits roll below now says once,
       properly, alongside every other role. What is left is the only account
       anywhere on this site of what playing the game is like, which is why
       these two rows survived a round that was about cutting. */
    acts: [
      {
        n: "I",
        title: "Dimming",
    ...
    /* ── 2. THE TWO OF US ─────────────────────────────────────────────────
       ONE line each since Round 37. It was four sentences each, and three of
       the four facts in them are now rows in the roll below. */
    ...
    people: [
      {
        ...
        role: [
          "Wrote the story and the cut scenes, directed the game, worked on the visuals, and built this website on his own."
        ]
      },
      {
        name: "Ravi Kishor R.",
        ...
        role: [
          "Wrote the larger half of the game code, the whole of Act I, the animations, the interface and the menu screen, and worked on the visuals."
        ]
      }
    ],
    /* ── 3. THE ROLL ──────────────────────────────────────────────────────
           New in Round 37. A game's own credits screen: department on the left,
           name on the right, one row each, nothing said twice. This is what the
           owner asked for in place of the prose — "add like a credits screen with
           who did what" — and it is a better instrument than paragraphs for the
           job, because a reader can find one role in one second.
    
           The percentages are printed as figures rather than spelled out. This is
           a table, and 55% is what a table says. */
    rollTitle: "Who did what.",
    roll: [
      { k: "Story", v: "Badriprasath K.V" },
      { k: "Direction", v: "Badriprasath K.V · Ravi Kishor R., assisting" },
      { k: "Visuals", v: "Badriprasath K.V · Ravi Kishor R." },
      { k: "Animation", v: "Ravi Kishor R." },
      { k: "Interface", v: "Ravi Kishor R." },
      { k: "Menu screen", v: "Ravi Kishor R." },
      { k: "Game code", v: "Ravi Kishor R. 55% · Badriprasath K.V 45%" },
      { k: "Act I — Dimming", v: "Ravi Kishor R." },
      { k: "Act II — Reboot", v: "Badriprasath K.V" },
      { k: "This website", v: "Badriprasath K.V" }
    ],
    /* One paragraph, and it is the owner's own framing rather than a hedge:
       equal work, different work, and the last sentence refuses to rank the
       two lists. It replaces four sentences spread across two cards, one of
       which read "he didn't work on this website; that part is mine" — true,
       and it sounded like a fence. */
    splitLabel: "And how it divided",
    splitBody: "We did equal work, and we did not do the same work. Ravi took the hard half of the game — most of the code, all of Act I, the animations, the interface, the menu screen — which is the part of building a game that most often defeats people. Badri wrote the story and the cut scenes, directed it, worked on the visuals, wrote the rest of the code, and built this website from nothing on his own. Neither of those is the smaller list.",
    /* ── 4. THE FEST, DEMOTED ─────────────────────────────────────────────
       It was the first section and two paragraphs. It is the fourth and one.
       The spec table is untouched: every row of it is read off the official
       STOGO deck, and it is the part of this page a judge actually needs. */
    festLabel: "What it was made for",
    festTitle: "STOGO Fest V4.0",
    festBody: [
      "STOGO Fest is a school festival that runs to a national and then an international round. This year its theme is Reboot: The Rhythm of Life, and every entry sits inside one of three streams. We took Substance Safety — a stream that could be answered with a poster telling you not to, which has been tried on all of us for years. So we answered it twice instead, with a game and with this."
    ],
    fest: [
