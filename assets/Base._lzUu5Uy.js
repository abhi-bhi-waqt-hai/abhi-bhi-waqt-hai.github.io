...
const en = {
  ...
  close: {
    ...
    note: "If someone will not wake up, none of this page applies yet. Call 112, or 108 for the ambulance, and read the first part of Right now, tonight while it rings."
  },
  now: {
    eyebrow: "The next ten minutes",
    title: "Right now, tonight.",
    lede: "Every other page here is about a decision you would make in the daytime, when the offices are open. This one is for the hour you are reading it in.",
    jumpLabel: "Nobody is in danger — I am just scared",
    jumpNotReady: "I am not trying to stop",
    jumpTonight: "What do I do tonight",
    dangerLabel: "Read this part first",
    dangerTitle: "If someone will not wake up.",
    dangerBody: "Not sleeping. Not just out of it. Will not wake up when you say their name and shake their shoulder. Do the first three in order. Then it splits, on one question: are they breathing?",
    dangerSteps: [
      "Call 112. Any phone, free, and it reaches ambulance, police and fire from one number. Say the address first, before you explain anything. If the call drops, they still have where you are.",
      "108 is the ambulance line on its own, and it runs in most states. If 112 does not connect, dial 108.",
      "Now find out if they are breathing. Put your ear next to their mouth so you could feel a breath on your cheek, and watch their chest. Ten seconds, no longer. Is air going in and out, normally?"
    ],
    breathingLabel: "If they ARE breathing",
    breathingSteps: [
      "Put them on their side, not on their back. On their back they can choke on their own sick. On their side it runs out.",
      "Once they are on their side, tilt their head back a little and lift their chin, so the air has a way in."
    ],
    notBreathingLabel: "If they are NOT breathing, or are only gasping",
    notBreathingSteps: [
      "Gasping is not breathing. About half of people whose heart has stopped will gasp in the first few minutes — mouth opening, neck stretching, slow noisy catches. It looks like breathing and it is the opposite. If you are not sure, treat it as not breathing.",
      "Do not put them on their side. This is the one place on this page where you do something else instead.",
      "Put the phone on the floor beside you on speaker. The person on 112 will talk you through it and count for you. Nobody expects you to know this already.",
      "Kneel next to them. Put the heel of one hand in the middle of their chest, your other hand on top, fingers locked. Arms straight, shoulders over your hands. Push down hard, about the depth of your palm, and let the chest come all the way back up each time.",
      "Push fast — about twice a second — and do not stop until somebody takes over. It is meant to be tiring. Doing it imperfectly is enormously better than not doing it."
    ],
    dangerAfter: [
      "Whichever half you did: keep checking they are still breathing until help arrives. If they were breathing and then stop, go to the other half.",
      "Stay. Do not put them to bed to sleep it off, and do not leave them with the only other person there being someone who is also not okay.",
      "When help arrives, say what was taken, if you know. They are there to treat the person in front of them, not to arrest anybody. For one kind of overdose there is a medicine that reverses it, and they can only use it if they know."
    ],
    dangerAvoidLabel: "And three things people try that make it worse",
    dangerAvoid: [
      "Do not try to make them sick. If they cannot wake up, they cannot protect their own throat, and it goes down the wrong way.",
      "Do not put them under a cold tap or a cold shower, and do not walk them up and down. Neither of those wakes anybody up, and both cost you the minutes the steps above need.",
      "Do not give them anything to drink. Same reason as the first one."
    ],
    dangerSource: "None of that is this page’s advice. The breathing check, the side position and the chest compressions are St John Ambulance’s, almost word for word, and all three are linked on the sources page.",
    dangerNote: "If you are wrong, and they were fine the whole time, then you were wrong and they are fine. That is the good ending. Nobody is angry at the person who called too early. It is waiting until you are sure that goes wrong.",
    notReadyLabel: "And if you are not stopping",
    notReadyTitle: "Safer than last week is a real thing to aim at.",
    notReadyBody: "Most people reading this have not decided to stop, and this page is not going to make you say it first. None of what follows is permission and none of it is a plan. It is what decides whether a bad night stays a bad night.",
    notReadyPoints: [
      "Everything on the list above needs somebody there to do it. That is why being on your own is the risk it is.",
      "One person who knows roughly where you are. Not a confession and not a conversation. Someone who could come and find you.",
      "After a break — weeks off, an illness, a stay somewhere — you are not where you were before it. The World Health Organization lists starting again after a stretch of not using among the things that most often go wrong.",
      ...
      "If it is new, or it came from somewhere new, it is an unknown thing and not the thing it is being called.",
      "Have 112 in your head now, while nothing is happening. Nobody looks up a number well at three in the morning."
    ],
    tonightLabel: "And otherwise",
    tonightTitle: "If none of that is happening, there is nothing you have to do tonight.",
  ...
  law: {
    ...
    notPromise: "None of this is a promise that nothing will happen. It is the opposite of a promise. It is the actual rule, with its limits printed beside it, so that you are deciding on something true instead of on a rumour."
  },
  /* ── The long version ──────────────────────────────────────────────
    ...
    groups: [
      ...
      },
      {
        ...
        rows: [
          ...
          {
            claim: "How to tell whether somebody is breathing, and that gasping is not breathing.",
            source: "St John Ambulance, the primary survey",
            url: "https://www.sja.org.uk/first-aid-advice/primary-survey/",
            note: "Their words: watch and listen for no more than ten seconds. About half of casualties whose heart has stopped will gasp in the first minutes, and in a person with no signs of life that gasping is a sign of cardiac arrest rather than of breathing."
          },
          {
            claim: "Somebody unresponsive and NOT breathing normally needs chest compressions, not the side position.",
            source: "St John Ambulance, CPR",
            url: "https://www.sja.org.uk/first-aid-advice/cpr/",
            note: "Heel of the hand in the middle of the chest, the other on top, fingers interlocked, arms straight, 100 to 120 pushes a minute. Their page also says to listen to the ambulance controller, who will count for you."
          },
          {
            claim: "Someone unresponsive but breathing goes on their side, head tilted back, chin lifted.",
            source: "St John Ambulance, recovery position",
            url: "https://www.sja.org.uk/first-aid-advice/recovery-position/",
            note: "Their reason: the airway is kept open and any vomit can drain away without interfering with breathing."
          },
          {
  ...
  credits: {
    ...
    lede: "This is a school project, and this is the only page here that is about us instead of about you. That is why it is last. There is nothing on it you need.",
    ...
    peopleTitle: "Two of us, and neither of us made all of it.",
    school: "Class VIII-B · Amrita Vidyalayam, Erode, Tamil Nadu",
    people: [
      {
        name: "Badriprasath K.V",
        stem: "badri",
        alt: "Badriprasath K.V, photographed on the steps of a temple tank.",
        what: "Story, direction, and this website",
        role: [
      ...
      },
      {
        name: "Ravi Kishor R.",
        stem: "ravi",
        alt: "Ravi Kishor R., photographed against a painted wall lit by ultraviolet light.",
        what: "Most of the code, and Act I",
        role: [
    ...
    gameLabel: "The other half of the entry",
    gameTitle: "PULSE — Reboot the Rhythm.",
    gameBody: [
    ...
    acts: [
      {
        n: "I",
        title: "Dimming",
        who: "Built by Ravi Kishor",
        what: "Five levels, from a warm terrace at six in the evening down into the tunnel. Your light is the only light. It gets smaller."
      },
      {
        n: "II",
        title: "Reboot",
        who: "Built by Badriprasath",
        what: "Five more, from a grey room at four in the morning back down the same stairs — this time with a friend holding a torch, a teacher, a grandmother and a doctor waiting at the top."
      }
    ],
    siteLabel: "How this site is built",
    siteTitle: "Eight pages, no account, nothing saved.",
    siteBody: [
    ...
    stack: [
      { k: "Pages", v: "Eight, static, no server" },
      { k: "Built with", v: "Astro" },
      { k: "Saved about you", v: "Nothing" },
      { k: "Sent anywhere", v: "Nothing" },
      { k: "Cookies", v: "None" }
    ],
    closingLabel: "The card at the end of the game",
    closing: [
      "If someone you love has gone quiet, you are not betraying them by telling someone.",
      "You are just refusing to do it alone."
    ],
    closingWho: "PULSE, post-credits"
  },
  footer: {
